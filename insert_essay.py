...
def insert_content_data():
    ...
    for item in items:
        ...
        for question in questions:
            sub_course_name = question[SUB_COURSE_TABLE_NAME_COLUMN]
            res, err = ddb.run_sql(
                BASE_CHECK_QUERY.format(
            ...
            texts = question[QUESTION_TABLE_TEXT_COLUMN]
            cur_count = 0
            ...
            for text in texts:
                ...
                _, err = ddb.run_sql(
                    QUESTION_INSERT_QUERY.format(
                        QUESTION_TABLE_NAME,
                        SUB_COURSE_TABLE_ID_COLUMN, QUESTION_TABLE_TEXT_COLUMN, QUESTION_TABLE_HASH_COLUMN,
                        sub_course_id, text, row_hash
                    )
                )
